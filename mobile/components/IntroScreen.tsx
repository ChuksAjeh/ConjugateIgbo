      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <Text style={styles.tagline}>
            Your one stop shop to learning Igbo
          </Text>
            ...
            <View style={styles.instructionsList}>
              <View style={styles.instructionItem}>
                ...
                <Text style={styles.instructionText}>
                  The card shows the verb, tense and pronoun.
                </Text>
              </View>
              ...
              <View style={styles.instructionItem}>
                ...
                <Text style={styles.instructionText}>
                  Practise saying the correct conjugation.
                </Text>
              </View>
              ...
              <View style={styles.instructionItem}>
                ...
                <Text style={styles.instructionText}>
                  Tap and see if you got it correct.
                </Text>
              </View>
              ...
              <View style={styles.instructionItem}>
                ...
                <Text style={styles.instructionText}>
                  Swipe to move on to the next verb.
                </Text>
              </View>
            </View>
          </View>
