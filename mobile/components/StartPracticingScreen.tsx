...
export default function StartPracticingScreen({ onFinish }: { onFinish: () => void }) {
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.tipsList}>
              <View style={styles.tipItem}>
                ...
                <Text style={styles.tipText}>If you're having trouble with a verb, save and come back later.</Text>
              </View>
              
              <View style={styles.tipItem}>
                <Text style={styles.tipBullet}>•</Text>
                <Text style={styles.tipText}>Play sounds to help with pronunciation.</Text>
              </View>
              
              <View style={styles.tipItem}>
                <Text style={styles.tipBullet}>•</Text>
                <Text style={styles.tipText}>Click on the book icon to learn more about the verb</Text>
              </View>
